...
export const HardDrive: React.FC = () => {
...
export const ArrowRightFromBracket: React.FC = () => {
...
export const FolderOpen: React.FC = () => {
...
export const EllipsisVertical: React.FC = () => {
...
export const RotateRight: React.FC = () => {
